...
var dnanmskmidrange = tryRequire( resolve( __dirname, './../lib/dnanmskmidrange.native.js' ) );
var opts = {
...
tape( 'the function has an arity of 5', opts, function test( t ) {
	t.strictEqual( dnanmskmidrange.length, 5, 'has expected arity' );
	t.end();
});
...
tape( 'the function calculates the mid-range of a strided array according to a mask, ignoring NaN values', opts, function test( t ) {
	...
	v = dnanmskmidrange( x.length, x, 1, mask, 1 );
...
tape( 'if provided an `N` parameter less than or equal to `0`, the function returns `NaN`', opts, function test( t ) {
	...
	v = dnanmskmidrange( 0, x, 1, mask, 1 );
	t.strictEqual( isnan( v ), true, 'returns expected value' );

	v = dnanmskmidrange( -1, x, 1, mask, 1 );
	t.strictEqual( isnan( v ), true, 'returns expected value' );
...
tape( 'the function supports `stride` parameters', opts, function test( t ) {
	...
	v = dnanmskmidrange( 6, x, 2, mask, 2 );
...
tape( 'the function supports view offsets', opts, function test( t ) {
	...
	v = dnanmskmidrange( 6, x1, 2, mask1, 2 );
	t.strictEqual( v, 1.0, 'returns expected value' );
