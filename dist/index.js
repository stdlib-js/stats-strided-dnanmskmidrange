"use strict";var m=function(e,i){return function(){try{return i||e((i={exports:{}}).exports,i),i.exports}catch(n){throw (i=0, n)}};};var q=m(function(G,g){
var _=require('@stdlib/math-base-assert-is-nan/dist'),b=require('@stdlib/math-base-assert-is-negative-zero/dist'),E=require('@stdlib/math-base-assert-is-positive-zero/dist');function O(e,i,n,f,t,c,Z){var v,u,s,o,r,a;if(e<=0)return NaN;for(s=f,o=Z,a=0;a<e&&(r=i[s],!(r===r&&t[o]===0));a++)s+=n,o+=c;if(a===e)return NaN;for(u=r,v=u,a+=1,a;a<e;a++)s+=n,o+=c,!t[o]&&(r=i[s],!_(r)&&(r<u||r===u&&b(r)?u=r:(r>v||r===v&&E(r))&&(v=r)));return(v+u)/2}g.exports=O
});var y=m(function(H,x){
var p=require('@stdlib/strided-base-stride2offset/dist'),P=q();function h(e,i,n,f,t){return P(e,i,n,p(e,n),f,t,p(e,t))}x.exports=h
